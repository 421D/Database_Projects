    							...
    							<table border="0" cellpadding="0" cellspacing="0" class="mytable">
    								...
    								<c:if test="${not empty alist}">
	    								<tr bgcolor="#4a4a4a">
											...
											<th width="80px"  style="color:white;">预约码</th>
    								...
    								<c:forEach var="a" items="${alist}">
    									<tr>
											...
											<td width="100px"  >${a.reservationcode }</td>
    										<td>
											<!--
											...
											-->
    											<c:if test="${a.lyflag eq '已预订'}">
	    											<input type="button" value="退订" onclick="hpbt('${a.id}','tp');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
    											</c:if>
